      ...
      <div className="flex flex-grow flex-col items-center">
        <div className="bg-purple-100 p-8 rounded-lg m-4 ">
          <div className='flex justify-center'>
            ...
            <FontAwesomeIcon icon={faLock} size="3x" className="text-purple-600" />
            </div>
          </div>
          <h2 className="text-3xl text-purple-800 mb-4 text-center">Register</h2>
          <form className="flex flex-col items-center" onSubmit={formik.handleSubmit}>
            ...
            >
              ...
              <Link to={'/login'}>
              Already a member? <span className='text-purple-800 text-lg'>Sign in</span>
              </Link>
          </form>
        </div>
      </div>
